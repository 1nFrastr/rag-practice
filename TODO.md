...
#### [x] 1. 流式响应（Streaming Response）✅
- [x] 修改 `query_engine.py` 支持流式输出
- [x] 更新 `app.py` 使用 Gradio 的流式组件
- [x] 测试流式响应功能
- [x] 更新文档
...
#### [x] 6. 查询改写/扩展（Query Transformation）✅
- [x] 实现 Multi-Query Retriever（查询分解）
- [x] 添加查询改写管道（chat_engine中已实现）
- [x] 添加配置选项（UI开关）
- [x] 测试查询改写效果
- [x] 更新文档
...
**实现说明**:
- 新增 `query_decomposer.py`：识别多实体/比较类问题并分解为子查询
- 支持的问题类型：比较问题（A和B的共同点）、多实体问题（A、B、C分别...）
- 使用 RRF 融合策略合并多个子查询的检索结果
...
- [x] **流式响应** (2026-01-11) - 提升用户体验，实时显示生成内容
- [x] **多轮对话** (2026-01-11) - 支持上下文理解和查询改写
- [x] **查询分解** (2026-01-11) - 支持多实体/比较类问题的自动分解和多查询检索
